...
void THNN_(TemporalConvolution_updateOutput)(
  ...
  if (input->nDimension == 2)
  {
    ...
    for(k = 0; nOutputFrame > 0; k++)
    {
      ...
      THCTensor_(addmm)(state, outputWindow, ScalarConvert<int, ntype>::to(1), outputWindow, ScalarConvert<int, ntype>::to(1), inputWindow, tweight);
...
void THNN_(TemporalConvolution_updateGradInput)(
  ...
  if (gradOutput->nDimension == 2)
  {
    ...
    for(k = 0; nOutputFrame > 0; k++)
    {
      ...
      THCTensor_(addmm)(state, gradInputWindow, ScalarConvert<int, ntype>::to(1), gradInputWindow, ScalarConvert<int, ntype>::to(1), gradOutputWindow, weight);
    }
  }
  else
  {
...
void THNN_(TemporalConvolution_accGradParameters)(
  ...
  if (input->nDimension == 2)
  {
    ...
    for(k = 0; nOutputFrame > 0; k++)
    {
      ...
      THCTensor_(addmm)(state, gradWeight, ScalarConvert<int, ntype>::to(1), gradWeight, scale, tgradOutputWindow, inputWindow);
