...
static void (*THVector_(fill_DISPATCHPTR))(ntype *, const ntype, const ptrdiff_t) = &THVector_(fill_DEFAULT);
...
void THVector_(fill)(ntype *x, const ntype c, const ptrdiff_t n) {
  THVector_(fill_DISPATCHPTR)(x, c, n);
}

static void (*THVector_(cadd_DISPATCHPTR))(ntype *, const ntype *, const ntype *, const ntype, const ptrdiff_t) = &THVector_(cadd_DEFAULT);
...
void THVector_(cadd)(ntype *z, const ntype *x, const ntype *y, const ntype c, const ptrdiff_t n) {
  THVector_(cadd_DISPATCHPTR)(z, x, y, c, n);
}

static void (*THVector_(adds_DISPATCHPTR))(ntype *, const ntype *, const ntype, const ptrdiff_t) = &THVector_(adds_DEFAULT);
...
TH_API void THVector_(adds)(ntype *r_, const ntype *t, const ntype value, const ptrdiff_t n) {
  THVector_(adds_DISPATCHPTR)(r_, t, value, n);
}

static void (*THVector_(cmul_DISPATCHPTR))(ntype *, const ntype *, const ntype *, const ptrdiff_t) = &THVector_(cmul_DEFAULT);
...
void THVector_(cmul)(ntype *z, const ntype *x, const ntype *y, const ptrdiff_t n) {
  THVector_(cmul_DISPATCHPTR)(z, x, y, n);
}

static void (*THVector_(muls_DISPATCHPTR))(ntype *, const ntype *, const ntype, const ptrdiff_t) = &THVector_(muls_DEFAULT);
...
void THVector_(muls)(ntype *y, const ntype *x, const ntype c, const ptrdiff_t n) {
  THVector_(muls_DISPATCHPTR)(y, x, c, n);
}

static void (*THVector_(cdiv_DISPATCHPTR))(ntype *, const ntype *, const ntype *, const ptrdiff_t) = &THVector_(cdiv_DEFAULT);
...
void THVector_(cdiv)(ntype *z, const ntype *x, const ntype *y, const ptrdiff_t n) {
  THVector_(cdiv_DISPATCHPTR)(z, x, y, n);
}

static void (*THVector_(divs_DISPATCHPTR))(ntype *, const ntype *, const ntype, const ptrdiff_t) = &THVector_(divs_DEFAULT);
...
void THVector_(divs)(ntype *y, const ntype *x, const ntype c, const ptrdiff_t n) {
  THVector_(divs_DISPATCHPTR)(y, x, c, n);
}

static void (*THVector_(copy_DISPATCHPTR))(ntype *, const ntype *, const ptrdiff_t) = &THVector_(copy_DEFAULT);
...
void THVector_(copy)(ntype *y, const ntype *x, const ptrdiff_t n) {
  THVector_(copy_DISPATCHPTR)(y, x, n);
}

static void (*THVector_(normal_fill_DISPATCHPTR))(ntype *, const int64_t, THGenerator *, const ntype, const ntype) = &THVector_(normal_fill_DEFAULT);
static FunctionDescription THVector_(normal_fill_DISPATCHTABLE)[] = {
  #if defined(TH_NTYPE_IS_FLOAT) && defined(USE_AVX2)
...
void THVector_(normal_fill)(ntype *data,
                            const int64_t size,
