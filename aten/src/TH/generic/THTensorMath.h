...
TH_API void THTensor_(fill)(THTensor *r_, ntype value);
TH_API void THTensor_(zero)(THTensor *r_);

TH_API void THTensor_(maskedFill)(THTensor *tensor, THByteTensor *mask, ntype value);
...
TH_API void THTensor_(indexFill)(THTensor *tensor, int dim, THLongTensor *index, ntype val);
...
TH_API void THTensor_(scatterFill)(THTensor *tensor, int dim, THLongTensor *index, ntype val);

TH_API accntype THTensor_(dot)(THTensor *t, THTensor *src);

TH_API ntype THTensor_(minall)(THTensor *t);
TH_API ntype THTensor_(maxall)(THTensor *t);
TH_API ntype THTensor_(medianall)(THTensor *t);
TH_API accntype THTensor_(sumall)(THTensor *t);
TH_API accntype THTensor_(prodall)(THTensor *t);

TH_API void THTensor_(neg)(THTensor *self, THTensor *src);
TH_API void THTensor_(cinv)(THTensor *self, THTensor *src);

TH_API void THTensor_(add)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(sub)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(add_scaled)(THTensor *r_, THTensor *t, ntype value, ntype alpha);
TH_API void THTensor_(sub_scaled)(THTensor *r_, THTensor *t, ntype value, ntype alpha);
TH_API void THTensor_(mul)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(div)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(lshift)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(rshift)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(fmod)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(remainder)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(clamp)(THTensor *r_, THTensor *t, ntype min_value, ntype max_value);
TH_API void THTensor_(bitand)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(bitor)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(bitxor)(THTensor *r_, THTensor *t, ntype value);

TH_API void THTensor_(cadd)(THTensor *r_, THTensor *t, ntype value, THTensor *src);
TH_API void THTensor_(csub)(THTensor *self, THTensor *src1, ntype value, THTensor *src2);
...
TH_API void THTensor_(addcmul)(THTensor *r_, THTensor *t, ntype value, THTensor *src1, THTensor *src2);
TH_API void THTensor_(addcdiv)(THTensor *r_, THTensor *t, ntype value, THTensor *src1, THTensor *src2);

TH_API void THTensor_(addmv)(THTensor *r_, ntype beta, THTensor *t, ntype alpha, THTensor *mat,  THTensor *vec);
TH_API void THTensor_(addmm)(THTensor *r_, ntype beta, THTensor *t, ntype alpha, THTensor *mat1, THTensor *mat2);
TH_API void THTensor_(addr)(THTensor *r_,  ntype beta, THTensor *t, ntype alpha, THTensor *vec1, THTensor *vec2);

TH_API void THTensor_(addbmm)(THTensor *r_, ntype beta, THTensor *t, ntype alpha, THTensor *batch1, THTensor *batch2);
TH_API void THTensor_(baddbmm)(THTensor *r_, ntype beta, THTensor *t, ntype alpha, THTensor *batch1, THTensor *batch2);

TH_API void THTensor_(match)(THTensor *r_, THTensor *m1, THTensor *m2, ntype gain);
...
TH_API accntype THTensor_(trace)(THTensor *t);
...
TH_API void THTensor_(cmaxValue)(THTensor *r, THTensor *t, ntype value);
TH_API void THTensor_(cminValue)(THTensor *r, THTensor *t, ntype value);
...
TH_API void THTensor_(arange)(THTensor *r_, accntype xmin, accntype xmax, accntype step);
TH_API void THTensor_(range)(THTensor *r_, accntype xmin, accntype xmax, accntype step);
...
TH_API void THTensor_(ltValue)(THByteTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(leValue)(THByteTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(gtValue)(THByteTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(geValue)(THByteTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(neValue)(THByteTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(eqValue)(THByteTensor *r_, THTensor* t, ntype value);

TH_API void THTensor_(ltValueT)(THTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(leValueT)(THTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(gtValueT)(THTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(geValueT)(THTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(neValueT)(THTensor *r_, THTensor* t, ntype value);
TH_API void THTensor_(eqValueT)(THTensor *r_, THTensor* t, ntype value);
...
TH_API void THTensor_(pow)(THTensor *r_, THTensor *t, ntype value);
TH_API void THTensor_(tpow)(THTensor *r_, ntype value, THTensor *t);
...
TH_API void THTensor_(lerp)(THTensor *r_, THTensor *a, THTensor *b, ntype weight);
...
TH_API void THTensor_(norm)(THTensor *r_, THTensor *t, ntype value, int dimension, int keepdim);
TH_API void THTensor_(renorm)(THTensor *r_, THTensor *t, ntype value, int dimension, ntype maxnorm);
TH_API accntype THTensor_(dist)(THTensor *a, THTensor *b, ntype value);
TH_API void THTensor_(histc)(THTensor *hist, THTensor *tensor, int64_t nbins, ntype minvalue, ntype maxvalue);
TH_API void THTensor_(bhistc)(THTensor *hist, THTensor *tensor, int64_t nbins, ntype minvalue, ntype maxvalue);

TH_API accntype THTensor_(meanall)(THTensor *self);
TH_API accntype THTensor_(varall)(THTensor *self, int biased);
TH_API accntype THTensor_(stdall)(THTensor *self, int biased);
TH_API accntype THTensor_(normall)(THTensor *t, ntype value);

TH_API void THTensor_(linspace)(THTensor *r_, ntype a, ntype b, int64_t n);
TH_API void THTensor_(logspace)(THTensor *r_, ntype a, ntype b, int64_t n);
