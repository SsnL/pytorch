...
void TH_CONCAT_4(TH,TYPEC,Storage_copyCuda,Ntype)(THCState *state, TH##TYPEC##Storage *self, struct THCStorage *src) \
{                                                                           \
  ...
  TH_CONCAT_4(TH,TYPEC,Tensor_copyCuda,Ntype)(state, selfTensor, srcTensor); \
