...
THD_API void THDTensor_(fill)(THDTensor *r_, ntype value);
THD_API void THDTensor_(zero)(THDTensor *r);
THD_API void THDTensor_(maskedFill)(THDTensor *tensor, THDByteTensor *mask, ntype value);
...
THD_API void THDTensor_(indexFill)(THDTensor *tensor, int dim, THDLongTensor *index, ntype val);
...
THD_API void THDTensor_(range)(THDTensor *r_, accntype xmin, accntype xmax, accntype step);
...
THD_API void THDTensor_(ltValue)(THDByteTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(leValue)(THDByteTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(gtValue)(THDByteTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(geValue)(THDByteTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(neValue)(THDByteTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(eqValue)(THDByteTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(ltValueT)(THDTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(leValueT)(THDTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(gtValueT)(THDTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(geValueT)(THDTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(neValueT)(THDTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(eqValueT)(THDTensor *r_, THDTensor *t, ntype value);
...
THD_API void THDTensor_(pow)(THDTensor *r_, THDTensor *t, ntype value);
THD_API void THDTensor_(tpow)(THDTensor *r_, ntype value, THDTensor *t);
...
THD_API void THDTensor_(lerp)(THDTensor *r_, THDTensor *a, THDTensor *b, ntype weight);
...
THD_API void THDTensor_(norm)(THDTensor *r_, THDTensor *t, ntype value,
                              int dimension, int keepdim);
THD_API void THDTensor_(renorm)(THDTensor *r_, THDTensor *t, ntype value,
                                int dimension, ntype maxnorm);
THD_API accntype THDTensor_(dist)(THDTensor *a, THDTensor *b, ntype value);
...
THD_API void THDTensor_(bhistc)(THDTensor *hist, THDTensor *tensor, int64_t nbins,
                                ntype minvalue, ntype maxvalue);
THD_API accntype THDTensor_(meanall)(THDTensor *self);
THD_API accntype THDTensor_(varall)(THDTensor *self, int biased);
THD_API accntype THDTensor_(stdall)(THDTensor *self, int biased);
THD_API accntype THDTensor_(normall)(THDTensor *t, ntype value);
THD_API void THDTensor_(linspace)(THDTensor *r_, ntype a, ntype b, int64_t n);
THD_API void THDTensor_(logspace)(THDTensor *r_, ntype a, ntype b, int64_t n);
