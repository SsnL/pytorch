...
#define THPStorage_(NAME) TH_CONCAT_4(THDP,Ntype,Storage_,NAME)
...
#define THPTensor_(NAME) TH_CONCAT_4(THDP,Ntype,Tensor_,NAME)
#define THPTensor_stateless_(NAME) TH_CONCAT_4(THDP,Ntype,Tensor_stateless_,NAME)
