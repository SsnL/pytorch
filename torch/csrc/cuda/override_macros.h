...
#define THPStorage_(NAME) TH_CONCAT_4(THCP,Ntype,Storage_,NAME)
...
#define THPTensor_(NAME) TH_CONCAT_4(THCP,Ntype,Tensor_,NAME)
#define THPTensor_stateless_(NAME) TH_CONCAT_4(THCP,Ntype,Tensor_stateless_,NAME)
...
#define THSPTensor_(NAME) TH_CONCAT_4(THCSP,Ntype,Tensor_,NAME)
#define THSPTensor_stateless_(NAME) TH_CONCAT_4(THCSP,Ntype,Tensor_stateless_,NAME)
...
#define THHostTensor TH_CONCAT_3(TH,Ntype,Tensor)
#define THHostTensor_(NAME) TH_CONCAT_4(TH,Ntype,Tensor_,NAME)
#define THHostStorage TH_CONCAT_3(TH,Ntype,Storage)
#define THHostStorage_(NAME) TH_CONCAT_4(TH,Ntype,Storage_,NAME)
